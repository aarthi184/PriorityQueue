...
var pqSamples = []PriorityQueue{
    CreatePQElements([]Element{2,3,4},"binomialheap"),
    CreatePQElements([]Element{1,3,4,5,8},"binomialheap"),
    CreatePQElements([]Element{2,3},"binomialheap"),
    CreatePQElements([]Element{7,8,10,30,39,40,50},"binomialheap"),
}
...
var pqSamplesIsEmpty = []PriorityQueue{
    CreatePQElements([]Element{2},"binomialheap"),
    CreatePQElements([]Element{1,3},"binomialheap"),
    CreatePQElements([]Element{},"binomialheap"),
}
...
var pqSamplesInsert = []PriorityQueue{
    CreatePQElements([]Element{2,3,4},"binomialheap"),
    CreatePQElements([]Element{11,13,14,15,18},"binomialheap"),
    CreatePQElements([]Element{2,3},"binomialheap"),
    CreatePQElements([]Element{},"binomialheap"),
}
...
func BenchmarkInsert3(b *testing.B) {
    pq := CreatePQElements([]Element{2,3,4},"binomialheap")
    for n:=0;n<b.N;n++ {
        pq.Insert(5)
    }
}
...
func BenchmarkInsert6(b *testing.B) {
    pq := CreatePQElements([]Element{2,3,4,5,6,7},"binomialheap")
    for n:=0;n<b.N;n++ {
        pq.Insert(1)
    }
}
...
func BenchmarkInsert1M(b *testing.B) {
    pq := CreatePQElements([]Element{},"binomialheap")
    for i:=1;i <= 100; i++ {
         pq.Insert(Element(i))
    }
...
func BenchmarkIsEmpty2(b *testing.B) {
    pq := CreatePQElements([]Element{7,8,9,0},"binomialheap")
    for n:=0;n<b.N;n++ {
        pq.IsEmpty()
    }
}
...
func BenchmarkFindMin(b *testing.B) {
    pq := CreatePQElements([]Element{2,3,4,5,6},"binomialheap")
    for n:=0;n<b.N;n++ {
        pq.FindMin()
    }
}
